...
class FestivalDeInvierno extends FunSuite {
  ...
  test("Torneo Simple"){
    ...
    assertResult(torneo.jugar(List(vikingo,vikingo2),ReglasDeEliminacion(1)))(Some(Vikingo("Willy1",CaracteristicasVikingo(15,2,9,5),Some(SistemaDeVuelo),List())))
  ...
  test("Torneo con multiples postas y vikingos"){
    ...
    assertResult(torneo.jugar(List(vikingo,vikingo2,vikingo3,vikingo4),ReglasDeEliminacion(1)))(Some(Vikingo("Willy3",CaracteristicasVikingo(13,2,7,15),None,List())))
  ...
  test("Torneo se juegan todas las postas"){
    ...
    assertResult(torneo.jugar(List(vikingo,vikingo2,vikingo3,vikingo4), ReglasDeEliminacion(1)))(Some(Vikingo("Willy3",CaracteristicasVikingo(13,2,7,20),None,List())))
