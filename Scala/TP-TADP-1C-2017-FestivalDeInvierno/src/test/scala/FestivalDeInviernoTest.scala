...
class FestivalDeInviernoTest extends FunSuite {
  ...
  test("Aumentar Hambre Por Posta"){
    var vikingo = Vikingo(CaracteristicasVikingo(11,2,5,0),None,None,List())
    var posta=Pesca(Some(10))
    assertResult(vikingo.aumentarHambrePorPosta(posta))(Vikingo(CaracteristicasVikingo(11,2,5,5),None,None,List()))
  }
  ...
  test("Montar un Dragon Con Item"){
    var vikingo = Vikingo(CaracteristicasVikingo(1,2,5,0),Some(SistemaDeVuelo),None,List())
  ...
  test("Puedo Participar en Posta"){
    var vikingo = Vikingo(CaracteristicasVikingo(11,2,5,0),None,None,List())
    var vikingo2 = Vikingo(CaracteristicasVikingo(11,2,5,0),None,None,List())
    var posta=Pesca(Some(10))
    assertResult(posta.participarEnPosta(List(vikingo,vikingo2)))(List(Vikingo(CaracteristicasVikingo(11,2,5,5),None,None,List()),Vikingo(CaracteristicasVikingo(11,2,5,5),None,None,List())))
  }

  test("Soy Mejor que Otro"){
    var vikingo = Vikingo(CaracteristicasVikingo(11,2,5,0),None,None,List())
    var vikingo2 = Vikingo(CaracteristicasVikingo(15,2,5,0),None,None,List())
    var posta=Pesca(Some(10))
  ...
  test("Torneo Simple"){
    var vikingo = Vikingo(CaracteristicasVikingo(11,2,9,0),Some(SistemaDeVuelo),None,List())
    ...
    assertResult(torneo.jugar())(Some(Vikingo(CaracteristicasVikingo(15,2,9,5),Some(SistemaDeVuelo),None,List())))

  }

  test("Torneo con multiples postas y vikingos"){
    var vikingo = Vikingo(CaracteristicasVikingo(11,2,5,0),None,None,List())
    var vikingo2 = Vikingo(CaracteristicasVikingo(12,2,5,0),None,None,List())
    var vikingo3 = Vikingo(CaracteristicasVikingo(13,2,5,0),None,None,List())
    var vikingo4 = Vikingo(CaracteristicasVikingo(14,2,5,0),None,None,List())
    var posta=Pesca(Some(10))
    ...
    assertResult(torneo.jugar())(Some(Vikingo(CaracteristicasVikingo(13,2,5,15),None,None,List())))


  }

  test("Torneo se juegan todas las postas"){
    var vikingo = Vikingo(CaracteristicasVikingo(15,2,5,0),None,None,List())
    var vikingo2 = Vikingo(CaracteristicasVikingo(12,2,6,0),None,None,List())
    var vikingo3 = Vikingo(CaracteristicasVikingo(13,2,7,0),None,None,List())
    var vikingo4 = Vikingo(CaracteristicasVikingo(14,2,8,0),None,None,List())
    ...
    assertResult(torneo.jugar())(Some(Vikingo(CaracteristicasVikingo(13,2,7,20),None,None,List())))
